...
//    static int numReplications = 30;
     ...
     */
    public Memetico_TC_2(IPCLogger logger, ValidityFlag.ReadOnly continuePermission, ProblemInstance problem, 
...
//        String OPCrossover = "Multiple Fragment - NNRER";
        ...
        String OPMutacao = "MutationInsertion";
...
//        System.out.println("Graph Name = " + graph_name);
                ...
                Memetico_TC_2 meme = new Memetico_TC_2(logger, () -> true, problem, structSol, structPop, MetodoConstrutivo,
