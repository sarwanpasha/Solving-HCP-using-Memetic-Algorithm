...
public class Memetico_TC_NT_NTh {
...
//    static int numReplications = 30;
     ...
     */
    public Memetico_TC_NT_NTh(IPCLogger logger, ValidityFlag.ReadOnly continuePermission, ProblemInstance problem, 
        ...
        double[][] memeticoMat_temp;
        {
            ...
            for (int i = 0; i < inst.getDimension(); ++i) {
                for (int k = 0; k < inst.getDimension(); ++k) {
                    ...
                    if(memeticoMat[i][k]==2){
                        memeticoMat[i][k] = (inst.getDimension())*2;
                        memeticoMat[k][i] = (inst.getDimension())*2;
                    }
                    if(memeticoMat[i][k]==3){
                        memeticoMat[i][k] = (inst.getDimension())*2;
                        memeticoMat[k][i] = (inst.getDimension())*2;
                    }
...
//        System.out.println("Graph Name = " + graph_name);
                ...
                Memetico_TC_NT_NTh meme = new Memetico_TC_NT_NTh(logger, () -> true, problem, structSol, structPop, MetodoConstrutivo,
