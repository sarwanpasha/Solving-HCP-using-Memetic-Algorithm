...
//    static int numReplications = 30;
     ...
     */
    public Memetico_LK(IPCLogger logger, ValidityFlag.ReadOnly continuePermission, ProblemInstance problem, 
...
//        System.out.println("Graph Name = " + graph_name);
                ...
                problem.setTargetCost(orig_length_arr[count]);
                //default to false even though the lkh performance is good; just an example configuration
                boolean include_lkh_bool = true; 
                Memetico_LK meme = new Memetico_LK(logger, () -> true, problem, structSol, structPop, MetodoConstrutivo,
